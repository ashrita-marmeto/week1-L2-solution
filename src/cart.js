        ...
        return (shoppingCart.innerHTML = basket.map((x)=>{
            ...
            <div class="cart-item">
                ...
                <div class="details">
                    ...
                    <h3>Rs. ${noOfItems * search.price}</h3>
                </div>
            </div>
...
function   
 calculateAveragePrice() {
  const totalPrices = shopItemsData.reduce((total, item) => total + item.price, 0);
  const averagePrice = totalPrices / shopItemsData.length;
  return averagePrice;
}
...
let totalAmount = () =>{
    if(basket.length !==0){
        ...
        <p>Average Price: Rs. ${averagePrice.toFixed(2)}</p>
